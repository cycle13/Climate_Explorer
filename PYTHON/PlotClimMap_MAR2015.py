...
IsLand = False # True for land, False for marine
...
if (MyBundle == 'HadISDH.marineT'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_t_MPtrends_19732015'
...
if (MyBundle == 'HadISDH.marineTd'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_td_MPtrends_19732015'
...
if (MyBundle == 'HadISDH.marineTw'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_tw_MPtrends_19732015'
...
if (MyBundle == 'HadISDH.marineDPD'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_dpd_MPtrends_19732015'
...
if (MyBundle == 'HadISDH.marineRH'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_rh_MPtrends_19732015'
...
if (MyBundle == 'HadISDH.marineq'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_q_MPtrends_19732015'
...
if (MyBundle == 'HadISDH.marinee'):
    candidate='ERAclimNBC_5x5_monthly_anomalies_from_daily_both_relax_e_MPtrends_19732015'
